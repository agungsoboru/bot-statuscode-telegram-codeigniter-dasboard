<body style="background-color:#2c2f33;text-align:center">
  ...
  <body ng-app="myApp" ng-controller="myCtrl">
    ...
    <body class="">
      <div class="wrapper ">
        <div class="sidebar" data-color="purple" data-background-color="black" data-image="<?php echo base_url('assets/material-dashboard/assets/img/sidebar-1.jpg'); ?>">
          <!--
            ...
            <ul class="nav">
              ...
              <?php if (isset($user_permission)) { ?>
                ...
                <?php if (in_array('createUser', $user_permission) || in_array('updateUser', $user_permission) || in_array('viewUser', $user_permission) || in_array('deleteUser', $user_permission)) { ?>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('users/domain'); ?>">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('users/deletedomain'); ?>">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('users/bot'); ?>">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('users/botlog'); ?>">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('users/monitor'); ?>">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('users/apistatus'); ?>">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('users/vscode'); ?>">
