...
class Users extends Admin_Controller
{
	...
	public function domain()
	{
		...
		//$this->render_template('users/create', $this->data);
		$this->render_template('users/domain1', $this->data);
	}
	...
	public function deletedomain()
	{
		...
		//$this->render_template('users/create', $this->data);
		$this->render_template('users/deletedomain', $this->data);
	}
	...
	public function Botlog()
	{
		...
		//$this->render_template('users/create', $this->data);
		$this->render_template('users/botlog', $this->data);
	}
	...
	public function apistatus()
	{
		...
		//$this->render_template('users/create', $this->data);
		$this->render_template('users/apistatus', $this->data);
	}
	...
	public function vscode()
	{
		...
		//$this->render_template('users/create', $this->data);
		$this->render_template('users/vscode', $this->data);
	}
	...
	public function bot()
	{
		...
		//$this->render_template('users/create', $this->data);
		$this->render_template('users/bot', $this->data);
	}
	public function monitor()
	{

		//$this->render_template('users/create', $this->data);
		$this->render_template('users/monitor', $this->data);
	}
}
